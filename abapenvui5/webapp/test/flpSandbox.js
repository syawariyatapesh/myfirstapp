		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "An ABAP ENV Fiori app",
									"targetURL": "#saplearningabapenvui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"saplearningabapenvui5-display": {
								"semanticObject": "saplearningabapenvui5",
								"action": "display",
								"description": "A Fiori application on ABAP Environment",
								"title": "An ABAP ENV Fiori app",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.learning.abapenvui5",
									"url": sap.ui.require.toUrl("sap/learning/abapenvui5")
								}
							}
						}
					}
